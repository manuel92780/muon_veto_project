...
cor_multi_1, cor_edges_1   = np.histogram(cor_eventinfo[1], weights=cor_eventinfo[0], density=dens, bins=xbins, range=(xmin,xmax) )
mug_multi_1, mug_edges_1   = np.histogram(mug_eventinfo[1], weights=mug_eventinfo[0], density=dens, bins=xbins, range=(xmin,xmax) )
...
cor_energy_1, cor_edges_1   = np.histogram(cor_muon1info[0], weights=cor_eventinfo[0], density=dens, bins=logxbins, range=(xmin,xmax) )
mug_energy_1, mug_edges_1   = np.histogram(mug_muon1info[0], weights=mug_eventinfo[0], density=dens, bins=logxbins, range=(xmin,xmax) )
...
f, (ax1, ax2) = plt.subplots(2, 1, sharex=True, gridspec_kw = {'height_ratios':[2, 1]})
cor_zenith_1, cor_edges_1   = np.histogram(np.cos(cor_muon1info[1]), weights=cor_eventinfo[0], density=dens, bins=xbins, range=(xmin,xmax) )
mug_zenith_1, mug_edges_1   = np.histogram(np.cos(mug_muon1info[1]), weights=mug_eventinfo[0], density=dens, bins=xbins, range=(xmin,xmax) )
