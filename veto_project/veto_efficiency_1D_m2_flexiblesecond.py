...
#plt.show()
plt.savefig("energy_dist_bundle_2_only_one_required_to_enter_"+args.RANGE+"_fitrange.pdf")
print "Made file: " + "energy_dist_bundle_2_only_one_required_to_enter_"+args.RANGE+"_fitrange.pdf"
